            ...
            <table class="table table-striped btn-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="change-status.php?id=1&status=active" class="btn btn-sm btn-success"><i class="fas fa-check"></i></a></td>
                        <td>1</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><a href="change-status.php?id=3&status=inactive" class="btn btn-sm btn-danger"><i class="fas fa-minus"></i></a></td>
                        <td>2</td>
                        <td>

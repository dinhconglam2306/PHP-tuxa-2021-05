...
//link-form
$inputLink = Form::createInput('text', 'link', $this->output['link']);
$labelLink = Form::createLabel('Link', 'font-weight-bold');
$groupLink = Form::createFormGroup($labelLink, $inputLink);

//Ordering-form
$inputOrdering = Form::createInput('text', 'ordering', $this->output['ordering']);
...
$status      = Form::createSelectbox($arrStatus, 'status', $this->output['status'], 'custom-select');
...
<form action="index.php?controller=rss&action=add" method="post">
    <div class="card">
